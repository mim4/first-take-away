...
We have been able to change the random seed, the data partition and the method in which we perform the analysis (the options were ``lda``, ``qda`` and ``random forest``). Using these, we obtain:
